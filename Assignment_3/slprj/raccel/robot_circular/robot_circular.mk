...
#
# File    : raccel_unix.tmf   $Revision: 1.1.6.32 $
#
# Abstract:
...
MAKECMD         = /home/shashank/MATLAB/bin/glnxa64/gmake
HOST            = UNIX
BUILD           = yes
...
MODEL                  = robot_circular
MODULES                = robot_circular_data.c rtGetInf.c rtGetNaN.c rt_logging.c rt_nonfinite.c 
MAKEFILE               = robot_circular.mk
MATLAB_ROOT            = /home/shashank/MATLAB
ALT_MATLAB_ROOT        = /home/shashank/MATLAB
MATLAB_ROOTQ           = \"/home/shashank/MATLAB\"
MASTER_ANCHOR_DIR      = 
START_DIR              = /home/shashank/Desktop/RTES_Codes/Assignment_3
S_FUNCTIONS            = rtiostream_utils.c
S_FUNCTIONS_LIB        = 
COMPUTER               = GLNXA64
BUILDARGS              =  RSIM_SOLVER_SELECTION=2 PCMATLABROOT="/home/shashank/MATLAB" EXT_MODE=1 OPTS="-DON_TARGET_WAIT_FOR_START=0"
...
ADD_INCLUDES = \
	-I$(START_DIR)/slprj/raccel/robot_circular \
	-I$(START_DIR) \
